...
sidebar_position: 2
title: Health
description: Track biometrics, calories, water, and workouts in Xenith's Health dimension.
keywords:
  - health tracking app
  - calorie tracker
  - workout log
...
### Water
Track hydration (and supplements) across the day with quick taps. Small, frequent
...
Everything you log here feeds your Health dimension score and your
[Insights](../growth-and-insights/insights.md) balance chart. Pair Health logging
with a morning [intention](../daily-workflow/daily-intentions.md) when you want a
specific habit to stick.
