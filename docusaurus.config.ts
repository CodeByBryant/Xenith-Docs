...
const config: Config = {
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/CodeByBryant/Xenith-Docs/tree/main/",
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      {
        name: "keywords",
        content: "Xenith, docs, productivity, life dimensions, focus, growth",
      },
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Life Dimensions", to: "/life-dimensions/overview" },
